...
var skeleton := {
	...
	"npc_id": "skeleton",
	"alive": true,
	"relationship": -0.5,   # starts hostile
	"trust": 0.0,
...
# Generic validated state application for Farmer2, Princess2, Villager, Skeleton.
